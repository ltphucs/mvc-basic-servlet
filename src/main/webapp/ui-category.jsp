...
<body>
	...
	<section class="site-section">
		<div class="container">
			<div class="row mb-4">
				<div class="col-md-6">
					<h2 class="mb-4">Category: ${cat.name}</h2>
				</div>
			</div>
							...
							<c:forEach items='${requestScope["listBlog"]}' var='blogMain'>
								...
								<a href="#">
									<div class="image element-animate" data-animate-effect="fadeIn"
										style="background-image: url(${blogMain.imageUrl});"></div> <span
									class="text">
										<div class="post-meta">
											<span class="category">${blogMain.categoryName}</span> 
											<span class="mr-2">${blogMain.publishDate}</span> &bullet; <span class="ml-2"><span
												class="fa fa-comments"></span> ${blogMain.views}</span>
